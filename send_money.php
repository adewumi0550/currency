    	...
    	<div class="blankpage-main">
          ...
          <div class="group">
            <div class="form-group">
              ...
              <input type="text"   class="form-control" name="bank_acct"  required="required" placeholder="">
            </div>
          </div>
          ...
          <div class="group">
            <div class="form-group">
              ...
              <input type="text"   class="form-control" name="acct_name"  required="required" placeholder="">
            </div>
          </div>
          ...
          <div class="group">
            <div class="form-group">
              <label>Reciever Bank Name</label>
              <input type="text"   class="form-control" name="bank_name"  required="required" placeholder="">
            </div>
          </div>
    			...
    			<div class="group">
    				<div class="form-group">
    					<input type="submit" class="btn btn-success" name="save" value="Send Money">
    				</div>
    			</div>
